...
-- CreateEnum
CREATE TYPE "FreelancerStatus" AS ENUM ('AVAILABLE', 'BUSY', 'INACTIVE', 'ARCHIVED');
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectMember_projectId_freelancerId_key" ON "ProjectMember"("projectId", "freelancerId");
...
-- AddForeignKey
ALTER TABLE "ProjectMember" ADD CONSTRAINT "ProjectMember_freelancerId_fkey" FOREIGN KEY ("freelancerId") REFERENCES "Freelancer"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
