...
function Projects() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-gray-500">Projects you are currently assigned to.</p>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {loading ? (
              ...
              <tr>
                <td colSpan={6} className="px-4 py-6 text-center text-gray-500">No projects assigned yet.</td>
              </tr>
            ) : (
              projects.map((project) => (
                <tr key={project.id}>
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link to={`/freelancer/projects/${project.id}`} className="text-sm text-blue-600 hover:underline">
                      View
                    </Link>
                  </td>
                </tr>
